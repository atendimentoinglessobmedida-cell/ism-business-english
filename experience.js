...
(()=>{
 ...
 loadStyle('adaptive-coach.css?v=2');
 loadStyle('speaking-experience.css?v=1');
 ...
 loadScript('adaptive-coach.js?v=2');
 loadScript('speaking-experience.js?v=1');
 ...
 const observer=new MutationObserver(()=>requestAnimationFrame(attachSpeaking));const lessonBody=document.getElementById('lessonBody');if(lessonBody)observer.observe(lessonBody,{childList:true,subtree:true});window.addEventListener('load',attachSpeaking);
})();
